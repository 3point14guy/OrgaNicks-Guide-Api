...
dinner_and_diners = DinnerAndDiner.create([{ vegetable_id: 3, pest_id: 1 }, { vegetable_id: 6, pest_id: 1 }, { vegetable_id: 6, pest_id: 3 }, { vegetable_id: 6, pest_id: 8 }, { vegetable_id: 7, pest_id: 1 }, { vegetable_id: 7, pest_id: 6 }])

dinner_and_diners = DinnerAndDiner.create([{ vegetable_id: 7, pest_id: 7 }, { vegetable_id: 9, pest_id: 1 }, { vegetable_id: 9, pest_id: 3 }, { vegetable_id: 5, pest_id: 2 }, { vegetable_id: 5, pest_id: 1 }, { vegetable_id: 8, pest_id: 4 }])

dinner_and_diners = DinnerAndDiner.create([{ vegetable_id: 11, pest_id: 7 }, { vegetable_id: 8, pest_id: 1 }, { vegetable_id: 11, pest_id: 3 }, { vegetable_id: 11, pest_id: 8 }, { vegetable_id: 11, pest_id: 1 }])

dinner_and_diners = DinnerAndDiner.create([{ vegetable_id: 2, pest_id: 5 }, { vegetable_id: 2, pest_id: 1 }, { vegetable_id: 2, pest_id: 4 }])
